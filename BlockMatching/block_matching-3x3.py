...
mse_left = mse_left/(gdt_disp_lft.shape[0]*gdt_disp_lft.shape[1])
mse_right = mse_right/(gdt_disp_rght.shape[0]*gdt_disp_rght.shape[1])

print 'MSE for disparity left for 3X3 block is: ', mse_left
print 'MSE for disparity right for 3X3 block is: ', mse_right
